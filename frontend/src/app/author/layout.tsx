...
import { FileText, Home, LogOut, Menu, Settings, User, ChevronDown, BarChart2, Users } from "lucide-react"
      ...
      <div className={styles.navSection}>
        ...
        <div className={styles.navLinks}>
          <Link
            ...
            className={`${styles.navLink} ${isActive("/author/articles") ? styles.navLinkActive : ""}`}
          >
