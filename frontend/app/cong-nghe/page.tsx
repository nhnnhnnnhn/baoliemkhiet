          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-12">
              ...
              <h2 className="text-3xl font-serif font-bold mb-3 hover:text-purple-600">
                <Link href="#">Trí tuệ nhân tạo GPT-5 đạt bước tiến đột phá trong khả năng hiểu ngôn ngữ tự nhiên</Link>
              </h2>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <div className="md:w-2/3">
                        ...
                        <p className="text-gray-600 text-sm mb-2">
                          Thế hệ iPhone mới nhất của Apple được trang bị chip A18 và hệ thống camera được nâng cấp mạnh
                          mẽ.
                        </p>
