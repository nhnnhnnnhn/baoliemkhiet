...
router.get('/get-article/:articleId', authMiddleware, controller.getReportByArticleId);

// Get report by comment ID
router.get('/get-comment/:commentId', authMiddleware, controller.getReportByCommentId);
...
router.delete('/delete-multiple', authMiddleware, controller.deleteMultipleReports);
